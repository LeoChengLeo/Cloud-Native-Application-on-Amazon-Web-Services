...
stackID=$(aws cloudformation create-stack --template-body file://csye6225-cf-auto-scaling.yml --capabilities CAPABILITY_IAM --stack-name $1 --parameters  file://csye6225-cf.conf| grep StackId)
